...
namespace HaylandMontalvo_ProyectoCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HaylandMontalvo_ProyectoCFContext _context;

        public BurgersController(HaylandMontalvo_ProyectoCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'HaylandMontalvo_ProyectoCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HaylandMontalvo_ProyectoCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
